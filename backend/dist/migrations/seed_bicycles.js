    ...
    try {
        ...
        for (const bike of bicycles) {
            ...
            if (existing.length === 0) {
                await pool.query('INSERT INTO inventory_stok (kode_barang, nama_barang, kategori, tipe_item, jumlah_stok, satuan) VALUES (?, ?, ?, ?, ?, ?)', [bike.kode_barang, bike.nama_barang, bike.kategori, bike.tipe_item, bike.jumlah_stok, bike.satuan]);
